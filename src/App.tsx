        ...
        <Dialog.Viewport className="movie-metadata__viewport">
          <Dialog.Popup className="movie-metadata__popup">
            ...
            <div className="library-presentation__status">
              ...
              />
              {presentation?.metadata.value?.source == null ? null : (
                <span>{presentation.metadata.value.source}</span>
              )}
            </div>
...
function LibraryMovieCard({
  ...
  return (
    <LibraryProviderCard
      ...
      source={movie.association === null ? "Local Library" : "TMDB"}
      title={primaryTitle}
...
function VrLibraryCard({
  ...
  return (
    <LibraryProviderCard
      actions={
        <>
          ...
          {presentation.metadata.retry === null ? null : (
            <Button
              aria-label={`Retry presentation: ${item.title}`}
      ...
      details={
        <ul aria-label={`Files for ${item.title}`} className="library-details__members">
          {item.files.map((file) => (
            <VrLibraryFileRow
              file={file}
              itemCode={item.code}
      ...
      ratio={ratio}
      secondary={secondary}
      source={metadata?.source ?? presentation.cover.source ?? "Local Library"}
      title={item.title}
      titleId={titleId}
    />
  );
...
function TvLibraryCard({
  ...
  return (
    <LibraryProviderCard
      ...
      source={item.association == null ? "Local Library" : "TMDB"}
      title={item.title}
      titleId={titleId}
    />
  );
